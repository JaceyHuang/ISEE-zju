...
void aes_polynomial_mul(unsigned char x[4], unsigned char y[4], unsigned char z[4]){
	...
	memcpy(temp, y, 4);
    z[3] = aes_8bit_mul_mod_0x11B(x[0], temp[0]) ^ aes_8bit_mul_mod_0x11B(x[1], temp[1]) ^ aes_8bit_mul_mod_0x11B(x[2], temp[2]) ^ aes_8bit_mul_mod_0x11B(x[3], temp[3]);
    z[2] = aes_8bit_mul_mod_0x11B(x[1], temp[0]) ^ aes_8bit_mul_mod_0x11B(x[2], temp[1]) ^ aes_8bit_mul_mod_0x11B(x[3], temp[2]) ^ aes_8bit_mul_mod_0x11B(x[0], temp[3]);
    z[1] = aes_8bit_mul_mod_0x11B(x[2], temp[0]) ^ aes_8bit_mul_mod_0x11B(x[3], temp[1]) ^ aes_8bit_mul_mod_0x11B(x[0], temp[2]) ^ aes_8bit_mul_mod_0x11B(x[1], temp[3]);
    z[0] = aes_8bit_mul_mod_0x11B(x[3], temp[0]) ^ aes_8bit_mul_mod_0x11B(x[0], temp[1]) ^ aes_8bit_mul_mod_0x11B(x[1], temp[2]) ^ aes_8bit_mul_mod_0x11B(x[2], temp[3]);
}
...
void MixColumnInverse(unsigned char *p, unsigned char a[4], int do_mul){
    ...
    for (i=0; i<4; i++){
      	if (do_mul) {
      		aes_polynomial_mul(a, p+4*i, p+4*i);
		}
		put_column(p+4*i, t, i);
   	}
   	memcpy(p, t, 16);
}
