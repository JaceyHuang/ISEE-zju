 ...
 */
extern void mqtt_init(mqtt_broker_handle_t* broker, const char* clientid);
 ...
 * @note Only has effect before to call mqtt_connect
 */
extern void mqtt_init_auth(mqtt_broker_handle_t* broker, const char* username, const char* password);
 ...
 * @note Only has effect before to call mqtt_connect
 */
extern void mqtt_set_alive(mqtt_broker_handle_t* broker, uint16_t alive);
 ...
 */
extern int mqtt_connect(mqtt_broker_handle_t* broker);
 ...
 * @retval -1 On IO error.
 */
extern int mqtt_disconnect(mqtt_broker_handle_t* broker);
 ...
 * @retval -1 On IO error.
 */
extern int mqtt_publish(mqtt_broker_handle_t* broker, const char* topic, const char* msg, uint8_t retain);
 ...
 * @retval -1 On IO error.
 */
extern int mqtt_publish_with_qos(mqtt_broker_handle_t* broker, const char* topic, const char* msg, uint8_t retain, uint8_t qos, uint16_t* message_id);
